...
class UnderdogDevsTests: XCTestCase {
    ...
    func testSuccessfulPlanetFetch() throws {
        ...
        let mockSession = MockSession(jsonString: successfulJSONString)
        networkController.fetchPlanets(using: mockSession) { result in
            switch result {
    ...
    func testInvalidJSONPlanetFetch() throws {
